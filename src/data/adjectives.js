const male = [
    'bastardo', 'lurido', 'infame', 'fatiscente', 'rognoso', 'scontato', 'spavaldo', 'sfarzoso', 'lascivo',
    ...
    'negro', 'ebreo', 'sodomita', 'malato', 'strabico', 'senzatetto', 'sputatore', 'impazzito', 'sfrenato', 'pazzo sgravato'
];

const female = [
    'bastarda', 'lurida', 'infame', 'fatiscente', 'rognosa', 'scontata', 'spavalda', 'sfarzosa', 'lasciva',
    ...
    'negra', 'ebrea', 'sodomita', 'malata', 'strabica', 'senzatetto', 'sputatrice', 'impazzita', 'sfrenata', 'pazza sgravata'
];
