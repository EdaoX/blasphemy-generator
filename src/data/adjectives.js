const male = [
    ...
    'negro', 'ebreo', 'sodomita', 'malato', 'strabico', 'senzatetto', 'sputatore', 'impazzito', 'sfrenato'
];
...
const female = [
    ...
    'negra', 'ebrea', 'sodomita', 'malata', 'strabica', 'senzatetto', 'sputatrice', 'impazzita', 'sfrenata'
];
